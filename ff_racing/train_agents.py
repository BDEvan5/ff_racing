...
from ff_racing.LearningAlgorithms.sac import TrainSAC, TestSAC
from ff_racing.LearningAlgorithms.ddpg import TrainDDPG, TestDDPG
from ff_racing.LearningAlgorithms.td3 import TrainTD3, TestTD3

from ff_racing.Planners.TrainTrajectoryFollow import TrajectoryFollowTrain
from ff_racing.Planners.TestTrajectoryFollow import TrajectoryFollowTest
from ff_racing.Planners.TestEndToEnd import EndToEndTest
from ff_racing.Planners.TrainEndToEnd import EndToEndTrain
...
def train_trajectoryFollowing_agent():
    map_name = "aut" # "aut", "esp", "gbr", "mco"
    agent_name = "TrajectoryFollower_SAC"
    # agent_name = "myFavouriteAgentTF_SAC"
    number_training_steps = 2000
